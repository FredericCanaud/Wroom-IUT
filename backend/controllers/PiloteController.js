...
module.exports.AjouterPilote = function(request, response) {
    ...
    async.parallel([
            ...
            function(callback) {
                modelePays.getNationalites(function(err, result) {
                    callback(null, result)
                });
            },
        ],
...
module.exports.ModifierPilote = function(request, response) {
    ...
    async.parallel([
            ...
            function(callback) {
                ...
                modelePilote.getDetailPilote(pilnum, function(err, result) {
                    callback(null, result)
                });
            }
        ],
...
module.exports.SupprimerPilote = function(request, response) {
    ...
    async.series([
            function(callback) {
                modeleCourse.supprimerCourseByPilnum(pilnum, function(err, result) {
                    callback(null, result)
                });
            },
            function(callback) {
                modeleEssais.supprimerEssaisByPilnum(pilnum, function(err, result) {
                    callback(null, result)
                });
            },
            function(callback) {
                modeleSponsorise.supprimerSponsoringByPilnum(pilnum, function(err, result) {
                    callback(null, result)
                });
            },
            function(callback) {
                modelePhoto.supprimerPhotoByPilnum(pilnum, function(err, result) {
                    callback(null, result)
                });
            },
            function(callback) {
                modelePilote.supprimerPilote(pilnum, function(err, result) {
                    callback(null, result)
                });
            },
        ],
