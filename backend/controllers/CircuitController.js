...
module.exports.InfoCircuit = function(request, response){
 ...
 module.exports.ModifierCircuit = function(request, response){
    ...
    async.parallel([
       function(callback){
           modeleCircuit.getDetailCircuit(cirnum, function (err, result) {callback(null,result)});
       },
       function(callback){
...
module.exports.SupprimerCircuit = function(request, response){
   ...
   async.series([
      function(callback){
          modeleEssais.supprimerEssaisByCirnum(cirnum, function (err, result) {callback(null, result)});
      },
      function(callback){
          modeleCourse.supprimerCourseByCirnum(cirnum, function (err, result) {callback(null, result)});
      },
      function(callback){
          modeleGrandPrix.supprimerGrandPrixByCirnum(cirnum, function (err, result) {callback(null,result)});
      },
      function(callback){
          modeleCircuit.supprimerCircuit(cirnum, function (err, result) {callback(null,result)});
      },
   ],
   function(err, result){
      if (err) {
