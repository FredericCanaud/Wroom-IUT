...
module.exports.RepertoireLettre = function(request, response) {
    ...
    async.parallel([
            ...
            function(callback) {
                modelePilote.getNomPilote(data, (function(err, result) {
                    callback(null, result)
                }));
            }
        ],
...
module.exports.InfoPilote = function(request, response) {
    ...
    async.parallel([
            function(callback) {
                modelePilote.getSponsorsFromPilote(data, (function(err, result) {
                    callback(null, result)
                }));
            },
            function(callback) {
                modelePilote.getPhotosFromPilote(data, (function(err, result) {
                    callback(null, result)
                }));
            }
        ],
